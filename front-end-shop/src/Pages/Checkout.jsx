...
const CheckoutPage = () => {
  ...
  const getBoxClasses = (option, isSelected) => {
    return `border p-2 lg:p-4 m-2 cursor-pointer text-center rounded-md ${
      isSelected ? "text-gray-200 bg-gray-900" : "border-gray-600 bg-gray-200"
    }`;
  };
      ...
      <form onSubmit={handleSubmit} className="">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="w-80 md:w-96 lg:w-full mx-auto bg-[#D9D9D9] p-6 space-y-2 rounded-md custom-login-register">
            ...
            />
            <textarea
              className="w-full input input-bordered p-4 h-32"
              name="note"
              placeholder="Notes"
              rows={5}
            ></textarea>
          ...
          <div className="w-80 md:w-96 lg:w-full mx-auto bg-[#D9D9D9] p-6 rounded-md custom-login-register">
            ...
            <div className="flex flex-col items-center">
              <div className="flex">
                <div
                  className={getBoxClasses(1, selectedPaymentOption === 1)}
                ...
                <div
                  className={getBoxClasses(2, selectedPaymentOption === 2)}
          ...
          <div className="w-80 md:w-96 lg:w-full mx-auto bg-[#D9D9D9] p-6 rounded-md custom-login-register">
            ...
            <div className="flex flex-col items-center">
              <div className="flex">
                <div
                  className={getBoxClasses(3, selectedDeliveryOption === 3)}
                  onClick={() => handleDeliverySelect(3)}
                >
                  <div className="flex flex-col gap-2 items-center justify-center">
                    <h4 className="text-2xl lg:text-4xl">
                      <TbTruckDelivery />
                ...
                <div
                  className={getBoxClasses(4, selectedDeliveryOption === 4)}
                  onClick={() => handleDeliverySelect(4)}
                >
                  <div className="flex flex-col gap-2 items-center justify-center">
                    <h4 className="text-2xl lg:text-4xl">
                      <FaShoppingBag />
