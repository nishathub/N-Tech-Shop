...
const CategoryProducts = () => {
  ...
  useEffect(() => {
    const categoryBrands = [
      ...new Set(oneCategoryProducts.map((product) => product.brand)),
    ];
  ...
  const handleBrandButtonClick = (brandName) => {
    const clickedBrandProducts = oneCategoryProducts.filter(
  ...
  return (
    <div
      style={!oneCategoryProducts.length ? bgStyle : {}}
      className="py-12 bg-[#BABCBF] px-4 xl:px-0"
    >
      {
