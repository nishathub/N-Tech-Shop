...
const Navbar2 = () => {
    ...
    return (
        <div className={`bg-base-300/90 md:py-2 ${isFixed ? 'fixed w-full z-10' : 'relative'}`}>
            <div className="navbar max-w-7xl mx-auto md:px-4 px-1">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        {isOpen &&
                            <ul tabIndex={0} className="menu text-gray-200 menu-sm dropdown-content mt-3 z-[1] p-2 bg-base-100/90 rounded-sm w-52">
                                {links}
                            </ul>
                        }
                    </div>
                    <div className="flex items-center">
                        ...
                        <Link to={'/'}><h2 className="hidden sm:inline-block px-4 font-semibold text-xl text-[#3BBFE3]">N-Tech</h2></Link>
                    </div>
                </div>
                                ...
                                {!user ?
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div onClick={handleDropdownClick} className="dropdown dropdown-end">
                                            ...
                                            <div tabIndex={0} className="mt-3 z-[1] card card-compact dropdown-content w-52 md:w-80 bg-base-100/90 shadow">
                                                {isOpen &&
