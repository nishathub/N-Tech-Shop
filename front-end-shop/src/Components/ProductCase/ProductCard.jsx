            ...
            <div className="flex gap-4 items-center rounded-md bg-base-100 p-1 md:p-4 shadow-xl md:max-h-56">
                ...
                <div className="w-full md:p-4 flex justify-between items-center">
                    ...
                    <div className="flex flex-col gap-4 pl-4 md:pl-0">
                        <Link to={`/products/brand/${brand}/${_id}`}><button className="btn btn-primary p-1 md:p-4">Details</button></Link>
                        <Link to={`/products/brand/${brand}/update/${_id}`}><button className="btn btn-accent p-1 md:p-4">Update</button></Link>
                    </div>
                </div>
            </div>
        </div>
