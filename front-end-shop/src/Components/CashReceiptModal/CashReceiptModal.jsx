    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center text-gray-800 z-50">
            <div className="bg-[#D9D9D9] p-4 md:p-8 rounded-md w-full max-w-md md:max-w-3xl mx-auto max-h-[90vh] overflow-y-auto">
                <h2 className="text-lg md:text-2xl font-bold mb-4 md:mb-8 text-center border-b border-black">Order Received</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                    ...
                    {/* Product Information */}
                    <div>
                        <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-4">Order Details</h3>
                        <div className="border-t border-black pt-2 md:pt-4">
                            {showCartItems.map((item, index) => {
                                ...
                                return (
                                    <div key={index} className="flex justify-between mb-1 md:mb-2">
                                        <span>
